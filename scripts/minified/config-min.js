/*  ###########################################################################
     ...
     */fep.config=function(){return[{elem:$(".tabs"),amd:["fep-functions"],func:"fepTabs"},{elem:$("nav"),amd:["keepinview"],plugin:"keepInView",opts:{zindex:"424"}},{elem:$(".datatable"),amd:["datatable","fep-functions"],plugin:"dataTable",opts:{aLengthMenu:[[5,10,20,-1],[5,10,20,"All"]],iDisplayLength:5,bLengthChange:!0,sPaginationType:"full_numbers",aoColumns:[null,null,null,{bSortable:!1}]}},{elem:$("canvas"),amd:["fep-functions"],module:"fepCanvas",method:["run"]}]};